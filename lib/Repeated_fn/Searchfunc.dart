            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color:Color.fromARGB(255, 131, 197, 179).withOpacity(0.6),
                      ...
                      suffixIcon: IconButton(
                        onPressed: () {
                          Fluttertoast.showToast(
                              ...
                              backgroundColor: Color.fromRGBO(143, 134, 134, 1),
                        ...
                        icon: Icon(
                          ...
                          color: Color.fromARGB(255, 14, 255, 251).withOpacity(0.6),
                        ),
                      ),
                      prefixIcon: Icon(
                        Icons.search,
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                //     100,
                                                                decoration: BoxDecoration(
                                                                    color: Color.fromARGB(255, 21, 240, 149)
                                                                        .withOpacity(
                                                                            0.2),
                                                                    borderRadius:
                                                                        BorderRadius.all(
